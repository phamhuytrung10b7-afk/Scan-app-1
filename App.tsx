...
const INITIAL_LAYOUT: FactoryLayout = {
  elements: [
    // Top Section
    { id: 'a1', type: 'area', x: 20, y: 20, width: 800, height: 150, name: 'Khu vực RMA / Test', status: 'active', color: '#fff' },
    { id: 'e1', type: 'machine', x: 50, y: 50, width: 300, height: 80, name: 'Line RMA', status: 'active', color: '#fff' },
    { id: 'e2', type: 'storage', x: 400, y: 40, width: 60, height: 50, name: 'Xe đẩy', status: 'active', color: '#fff' },
    { id: 'e3', type: 'storage', x: 400, y: 100, width: 60, height: 50, name: 'Xe đẩy', status: 'active', color: '#fff' },
    { id: 'e4', type: 'machine', x: 500, y: 40, width: 100, height: 100, name: 'Khu vực máy test lạnh', status: 'active', color: '#fff' },
    
    // Main Conveyor Line
    { id: 'c1', type: 'conveyor', x: 20, y: 250, width: 800, height: 40, name: 'Line chính nối thêm 2m về phía đóng thùng', status: 'active', color: '#2d5a27' },
    
    // Bottom Section
    { id: 'a2', type: 'area', x: 20, y: 400, width: 400, height: 200, name: 'Khu vực kho', status: 'active', color: '#fff' },
    { id: 'p1', type: 'storage', x: 40, y: 430, width: 80, height: 140, name: 'Pallet', status: 'active', color: '#fff', showCross: true },
    { id: 'p2', type: 'storage', x: 130, y: 430, width: 80, height: 140, name: 'Mút xốp', status: 'active', color: '#fff', showCross: true },
    
    // Labels & Arrows
    { id: 'l1', type: 'label', x: 400, y: 200, width: 100, height: 20, name: '8000 mm', status: 'active', color: '#000', fontSize: 12 },
    { id: 'ar1', type: 'arrow', x: 150, y: 200, width: 50, height: 0, name: '', status: 'active', color: '#000' },
    { id: 'ar2', type: 'arrow', x: 300, y: 200, width: 50, height: 0, name: '', status: 'active', color: '#000' },
    
    // Workers
    { id: 'w1', type: 'worker', x: 200, y: 300, width: 40, height: 40, name: 'Nguyễn Văn A', status: 'active', color: '#fbbf24', task: 'Kiểm tra ngoại quan' },
    { id: 'w2', type: 'worker', x: 400, y: 300, width: 40, height: 40, name: 'Trần Thị B', status: 'active', color: '#fbbf24', task: 'Đóng gói thùng' },
  ],
  connections: []
};
